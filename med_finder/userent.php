...
<form method="post" action="userent1.php">
    <p>Name:-<input type="text" name="h1" class="in"></p>
    <p>Gender: <input type="radio" name="h4"> Male <input type="radio" name="h4"> Female <input type="radio" name="h4"> Others </p>
    <p>Date of Birth:-  <input type="date" name="h5"></p>
    <p>Email:- <input type="email" name="h2" class="in"></p>
    <p>Contact:- <input type="text" name="h3" class="in"></p>
