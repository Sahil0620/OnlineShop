      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form method="post" action="checklogin.php" onSubmit="return B()" class="sign-in-form">
            ...
            <p class="social-text">Also log in with</p>
			...
			<!--Registration Part-->
          <form action="userent1.php" class="sign-up-form" method="post">
            ...
            <input type="submit" class="btn" value="Sign up" name="B1" id="B1"/>
