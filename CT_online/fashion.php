...
$sql="select * from productdata where category='fashion'";
...
if($n>0)
{
    ...
    while($rw=mysqli_fetch_array($result))
    {
            ...
            <div class="col-md-4 col-sm-6 col-lg-3" >
                <div class="card">
                    <a href="userReg.php"><img class="card-img img-thumbnail" src="seller/product_photos/<?php echo $pp;?>" style="min-width: 100%; max-height: 250px;"></a>
